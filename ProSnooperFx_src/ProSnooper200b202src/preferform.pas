...
begin
 ...
 //save settings
 frmLogin.SetRegistryData(HKEY_CURRENT_USER,'\Software\ProSnooperFx','colBackground',
    rdInteger, colBackground.Selected);

 frmLogin.SetRegistryData(HKEY_CURRENT_USER,'\Software\ProSnooperFx','colText1',
    rdInteger, colText1.Selected);

 frmLogin.SetRegistryData(HKEY_CURRENT_USER,'\Software\ProSnooperFx','colText2',
    rdInteger, colText2.Selected);

 frmLogin.SetRegistryData(HKEY_CURRENT_USER,'\Software\ProSnooperFx','colPrivate',
    rdInteger, colprivate.Selected);

 frmLogin.SetRegistryData(HKEY_CURRENT_USER,'\Software\ProSnooperFx','colActions',
    rdInteger, colactions.Selected);

 frmLogin.SetRegistryData(HKEY_CURRENT_USER,'\Software\ProSnooperFx','colJoins',
    rdInteger, coljoins.Selected);

 frmLogin.SetRegistryData(HKEY_CURRENT_USER,'\Software\ProSnooperFx','colParts',
    rdInteger, colparts.Selected);

 frmLogin.SetRegistryData(HKEY_CURRENT_USER,'\Software\ProSnooperFx','colQuits',
    rdInteger, colquits.Selected);

 frmLogin.SetRegistryData(HKEY_CURRENT_USER,'\Software\ProSnooperFx','EnableTimestamps',
    rdString, BoolToStr(cbTimestamps.Checked));

 frmLogin.SetRegistryData(HKEY_CURRENT_USER,'\Software\ProSnooperFx','TimeStampFormat',
    rdString, edTimeStamp.Text);

 frmLogin.SetRegistryData(HKEY_CURRENT_USER,'\Software\ProSnooperFx','ShowJoins',
    rdString, BoolToStr(cbJoins.Checked));

 frmLogin.SetRegistryData(HKEY_CURRENT_USER,'\Software\ProSnooperFx','ShowParts',
    rdString, BoolToStr(cbParts.Checked));

 frmLogin.SetRegistryData(HKEY_CURRENT_USER,'\Software\ProSnooperFx','ShowQuits',
    rdString, BoolToStr(cbQuits.Checked));

 frmLogin.SetRegistryData(HKEY_CURRENT_USER,'\Software\ProSnooperFx','BuddySound',
    rdString, edsndBuddy.Text);

 frmLogin.SetRegistryData(HKEY_CURRENT_USER,'\Software\ProSnooperFx','HiLiteSound',
    rdString, edsndhilite.Text);

 frmLogin.SetRegistryData(HKEY_CURRENT_USER,'\Software\ProSnooperFx','MsgSound',
    rdString, edsndmsg.Text);

 frmLogin.SetRegistryData(HKEY_CURRENT_USER,'\Software\ProSnooperFx','HostAwayText',
    rdString, edHostGameAway.Text);

 frmLogin.SetRegistryData(HKEY_CURRENT_USER,'\Software\ProSnooperFx','JoinAwayText',
    rdString, edJoinGameAway.Text);

 frmLogin.SetRegistryData(HKEY_CURRENT_USER,'\Software\ProSnooperFx','HostGameAnn',
    rdString, BoolToStr(cbHostGameAnn.Checked));

 frmLogin.SetRegistryData(HKEY_CURRENT_USER,'\Software\ProSnooperFx','HostGameAway',
    rdString, BoolToStr(cbHostGameAway.Checked));

 frmLogin.SetRegistryData(HKEY_CURRENT_USER,'\Software\ProSnooperFx','GetIP',
    rdString, BoolToStr(cbGetIP.Checked));

 frmLogin.SetRegistryData(HKEY_CURRENT_USER,'\Software\ProSnooperFx','JoinGameAway',
    rdString, BoolToStr(cbJoinGameAway.Checked));

 frmLogin.SetRegistryData(HKEY_CURRENT_USER,'\Software\ProSnooperFx','AwayAnnounce',
    rdString, BoolToStr(cbAwayAnnounce.Checked));

 frmLogin.SetRegistryData(HKEY_CURRENT_USER,'\Software\ProSnooperFx','ResumeAnnounce',
    rdString, BoolToStr(cbResumeAnnounce.Checked));

 frmLogin.SetRegistryData(HKEY_CURRENT_USER,'\Software\ProSnooperFx','SendAwayPriv',
    rdString, BoolToStr(cbSendAwayPriv.Checked));

 frmLogin.SetRegistryData(HKEY_CURRENT_USER,'\Software\ProSnooperFx','SendAwayHiLite',
    rdString, BoolToStr(cbSendAwayHiLite.Checked));

 frmLogin.SetRegistryData(HKEY_CURRENT_USER,'\Software\ProSnooperFx','FntSize',
    rdString, edFntSize.Text);

 frmLogin.SetRegistryData(HKEY_CURRENT_USER,'\Software\ProSnooperFx','Buddies',
    rdString,lbBuddies.Items.CommaText);

 frmLogin.SetRegistryData(HKEY_CURRENT_USER,'\Software\ProSnooperFx','Blink',
    rdString, BoolToStr(cbBlink.Checked));

 frmLogin.SetRegistryData(HKEY_CURRENT_USER,'\Software\ProSnooperFx','Waexe',
    rdString, edExe.Text);

 frmLogin.SetRegistryData(HKEY_CURRENT_USER,'\Software\ProSnooperFx','DisableScroll',
